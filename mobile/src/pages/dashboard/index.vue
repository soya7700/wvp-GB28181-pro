...
const entries = [{ name: '视频监控', icon: '▣', url: '/pages/device/index', tab: true }, { name: '站内消息', icon: '!', url: '/pages/message/index', tab: true }, { name: '录像查询', icon: '▶', url: '/pages/record/index', tab: true }, { name: '运维工具', icon: '◇', url: '/pages/proxy/index' }]
...
<style scoped>
.page { min-height: 100vh; padding: 24rpx; box-sizing: border-box; }.hero { padding: 38rpx 34rpx; color: #fff; background: linear-gradient(135deg,#2368f2,#598cf4); border-radius: 28rpx; }.hello,.desc { display:block; }.hello { font-size: 38rpx; font-weight: 700; }.desc { margin-top: 12rpx; opacity:.82; font-size: 24rpx; }.quick-grid { display:grid; grid-template-columns:repeat(4,1fr); gap:16rpx; margin-top:22rpx; }.quick { padding:26rpx 8rpx; display:flex; align-items:center; flex-direction:column; background:#fff; border-radius:22rpx; }.quick__icon { color:#2368f2; font-size:40rpx; }.quick__name { margin-top:12rpx; font-size:23rpx; }.section { margin-top:24rpx; padding:30rpx; background:#fff; border-radius:24rpx; }.section__head { display:flex; justify-content:space-between; font-size:30rpx; font-weight:600; }.refresh { color:#2368f2; font-size:25rpx; font-weight:400; }.loading,.info { padding:50rpx 0 20rpx; color:#7b8498; text-align:center; font-size:25rpx; }.info__label,.info__value { display:block; }.info__value { margin-top:12rpx; color:#172033; font-size:34rpx; font-weight:600; }.error { display:block; margin-top:12rpx; color:#d84b4b; }
